...
class _CalendarSectionState extends State<CalendarSection> {
  ...
  void initState() {
    super.initState();
    _currentWeek = _startOfWeek(widget.selectedDate);
    _controller = PageController(initialPage: _basePage);
    _initialWeek = _startOfWeek(widget.selectedDate);
  ...
  List<DateTime> _week(DateTime start) {
        ...
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (context, index) {
              final diff = index - _basePage;

              final start = _initialWeek.add(
                Duration(days: diff * 7),
              );

              final days = _week(start);
